...
function render() {
    ...
    updatePhysics(deltaTime * speedmultiply);
...
function updatecamera() {
    ...
    */
    ...
    var x = distancefromplayercamera * Math.sin(THREE.Math.degToRad(ydeg)) * Math.cos(THREE.Math.degToRad(360 - xdeg));
    var y = distancefromplayercamera * Math.sin(THREE.Math.degToRad(360 - xdeg));
    var z = distancefromplayercamera * Math.cos(THREE.Math.degToRad(ydeg)) * Math.cos(THREE.Math.degToRad(360 - xdeg));
    ...
    var y = distancefromplayercamera * Math.sin(THREE.Math.degToRad(xdeg));
    */
    ...
    camera.position.x = playerobject.position.x + x;
    camera.position.y = playerobject.position.y + y;
    camera.position.z = playerobject.position.z + z;
    camera.updateProjectionMatrix();
}
